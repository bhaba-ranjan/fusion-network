...
experiment.add_tag('changed-image-model')
experiment.log_asset('/home/bpanigr/Workspace/fusion-network/fusion-network/scripts/model_builder/image/image_head.py')
       ...
       with torch.no_grad():
        for val_file in val_files:
            ...
            for index, (stacked_images, pcl ,local_goal, gt_pts) in tqdm(enumerate(val_loader)):                
                ...
                utility, pts = model(stacked_images, local_goal)
        ...
        if (epoch+1) % 10 == 0:
            ...
            }, f'/scratch/bpanigr/model_weights/image/image_model_{epoch+1}_{avg_loss_on_validation}.pth')
